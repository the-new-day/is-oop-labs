...
public class ModifierCombinationTests
{
    ...
    {
        // Arrange
        var baseCreature = new OrdinaryCreature(new HealthPoints(3), new HealthPoints(10));
        var withShield = new MagicShieldModifier(baseCreature);
        var withMastery = new AttackMasteryModifier(withShield);
        var target = new OrdinaryCreature(new HealthPoints(1), new HealthPoints(20));

        // Act & Assert - check if shield works
        withMastery.TakeDamage(new HealthPoints(100));
        Assert.Equal(new HealthPoints(10), withMastery.HealthValue);
        withMastery.TakeDamage(new HealthPoints(5));
    ...
    public void AttackMastery_WithMagicShield_ShouldWorkTogether()
    {
        ...
        // Act & Assert - check if shield works
        withShield.TakeDamage(new HealthPoints(100));
        Assert.Equal(new HealthPoints(10), withShield.HealthValue);
        withShield.TakeDamage(new HealthPoints(5));
    ...
    {
        // Arrange
        var baseCreature = new OrdinaryCreature(new HealthPoints(2), new HealthPoints(10));
        ...
        withShield2.TakeDamage(new HealthPoints(100));
        ...
        withShield2.TakeDamage(new HealthPoints(5));
    ...
    public void MultipleAttackMasteries_ShouldStack()
    {
        ...
        var target = new OrdinaryCreature(new HealthPoints(1), new HealthPoints(50));
    ...
    {
        // Arrange
        var baseCreature = new OrdinaryCreature(new HealthPoints(3), new HealthPoints(15));
        var withShield = new MagicShieldModifier(baseCreature);
        var withMastery = new AttackMasteryModifier(withShield);
        ...
        withSecondShield.TakeDamage(new HealthPoints(100));
        Assert.Equal(new HealthPoints(15), withSecondShield.HealthValue);

        withSecondShield.TakeDamage(new HealthPoints(100));
        Assert.Equal(new HealthPoints(15), withSecondShield.HealthValue);

        withSecondShield.TakeDamage(new HealthPoints(5));
